...
from implementations_args import *
...
if __name__=="__main__":
    ...
    # peform preprocessing TODO seems to make it worse
    ...
    # split data
    (X_tr, Y_tr, ids_tr), (X_val, Y_val, ids_val) = split_data(X, Y, ids, val_prop=VAL_PRECENTAGE)
    ...
    for f_name, f in IMPLEMENTATIONS.items():
        ...
        args_train = {"X":X_tr, "Y":Y_tr, "W":W_init, "m":max_iters,
                        "g":gamma, "l":lambda_}
    ...
    # TODO replce whitespaces in function names
